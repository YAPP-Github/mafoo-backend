...
public record SharedMemberForAlbumResponse(
        ...
        public static SharedMemberForAlbumResponse fromDto(
            SharedMemberForAlbumDto dto
        ) {
            return new SharedMemberForAlbumResponse(
                dto.sharedMemberId(),
                dto.shareStatus(),
                dto.permissionLevel(),
                dto.memberId(),
