...
@Schema(description = "접근 권한이 있는 앨범 응답")
public record ViewableAlbumResponse(
        ...
        public static ViewableAlbumResponse fromDto(
            ViewableAlbumDto dto
        ) {
                return new ViewableAlbumResponse(
                    dto.albumId(),
                    dto.name(),
                    dto.type(),
